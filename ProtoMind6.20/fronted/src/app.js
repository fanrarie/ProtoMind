...
// 训练按钮点击事件
document
  .getElementById("train-prompt-btn")
...
// 描述提示词按钮
document
  .getElementById("description-prompt-btn-mqtt")
  .addEventListener("click", function () {
    const desPrompt = `
- Role: 通信协议架构师和网络安全协议专家
- Background: 用户需要根据IR文档和下列的MQTT3.1.1协议文档内容，详细定义MQTT3.1.1协议的IR文件结构，并提供完整的IR文件代码。这用户可能正在从事通信协议逆向工程相关的工作，需要对MQTT3.1.1协议进行深入理解和实现。
- Profile: 你是一位在通信协议领域有着深厚造诣的专家，精通网络安全和模糊测试技术，对下列协议的细节和实现有着全面的掌握。你熟悉IR文档和MQTT3.1.1协议文档的规范，能够精准地将协议的定义转化为代码结构。
- Skills: 你具备网络协议分析、代码实现、文档解读和结构化编程的能力，能够将复杂的协议规范转化为清晰的代码结构。
- Goals: 
  1. 根据IR文档和下列MQTT3.1.1协议文档内容，详细定义相应协议的IR文件结构。
  2. 提供完整的IR文件代码，确保代码符合协议规范并具有良好的可读性和可维护性。
  3. 确保statemachine中的每一个状态名，在IR中message的name属性都有相对应的报文规范。
- Constrains: 严格遵循IR文档和下列RFC文档的规范，确保代码的准确性和完整性。代码应具有良好的注释和文档，方便后续的维护和扩展。确保statemachine中的每一个状态名，在IR中message的name属性都有相对应的报文规范。
- OutputFormat: IR文件代码，包含必要的注释和文档说明，描述代码的功能和实现逻辑，同时提供必要的配置参数和运行环境说明。
- Workflow:
  1. 深入研究IR文档和下列MQTT3.1.1协议文档，理解下列协议的详细规范。
...
document
  .getElementById("description-prompt-btn-dns")
  .addEventListener("click", function () {
    const desPrompt = `
- Role: 通信协议架构师和网络安全协议专家
- Background: 用户需要根据IR文档和下列的DNS协议文档内容，详细定义DNS协议的IR文件结构，并提供完整的IR文件代码。这用户可能正在从事通信协议逆向工程相关的工作，需要对DNS协议进行深入理解和实现。
- Profile: 你是一位在通信协议领域有着深厚造诣的专家，精通网络安全和模糊测试技术，对下列协议的细节和实现有着全面的掌握。你熟悉IR文档和DNS协议文档的规范，能够精准地将协议的定义转化为代码结构。
- Skills: 你具备网络协议分析、代码实现、文档解读和结构化编程的能力，能够将复杂的协议规范转化为清晰的代码结构。
- Goals: 
  1. 根据IR文档和下列DNS协议文档内容，详细定义相应协议的IR文件结构。
  2. 提供完整的IR文件代码，确保代码符合协议规范并具有良好的可读性和可维护性。
  3. 确保statemachine中的每一个状态名，在IR中message的name属性都有相对应的报文规范。
- Constrains: 严格遵循IR文档和下列RFC文档的规范，确保代码的准确性和完整性。代码应具有良好的注释和文档，方便后续的维护和扩展。确保statemachine中的每一个状态名，在IR中message的name属性都有相对应的报文规范。
- OutputFormat: IR文件代码，包含必要的注释和文档说明，描述代码的功能和实现逻辑，同时提供必要的配置参数和运行环境说明。
- Workflow:
  1. 深入研究IR文档和下列DNS协议文档，理解下列协议的详细规范。
  2. 根据协议规范，设计IR文件的结构，包括协议头、消息类型、消息体等部分。
  3. 编写IR文件代码，确保代码符合协议规范，并添加必要的注释和文档说明。
  4. 严格IR文件提供的代码格式进行编写，不要添加其他元素。
  5. 确保statemachine中的每一个状态名，在IR中message的name属性都有相对应的报文规范。
...
document
  .getElementById("description-prompt-btn-modbus")
  .addEventListener("click", function () {
    const desPrompt = `
  - Role: 通信协议架构师和网络安全协议专家
  - Background: 
    1. 用户需要根据IR文档和下列的MODBUS over Serial Line Specification V1.02协议文档内容，详细定义MODBUS over Serial Line Specification V1.02协议的IR文件结构，并提供完整的IR文件代码。这用户可能正在从事通信协议逆向工程相关的工作，需要对modbus协议进行深入理解和实现。
    2.但请注意，下列的MODBUS over Serial Line Specification V1.02协议内容可能格式有误，你可以根据你的知识库检索MODBUS over Serial Line Specification V1.02的协议内容。
  - Profile: 你是一位在通信协议领域有着深厚造诣的专家，精通网络安全和模糊测试技术，对下列协议的细节和实现有着全面的掌握。你熟悉IR文档和MODBUS over Serial Line Specification V1.02协议文档的规范，能够精准地将协议的定义转化为代码结构。
  - Skills: 你具备网络协议分析、代码实现、文档解读和结构化编程的能力，能够将复杂的协议规范转化为清晰的代码结构。
  - Goals: 
    1. 根据IR文档和下列MODBUS over Serial Line Specification V1.02协议文档内容，详细定义相应协议的IR文件结构。
    2. 提供完整的IR文件代码，确保代码符合协议规范并具有良好的可读性和可维护性。
    3. 确保statemachine中的每一个状态名，在IR中message的name属性都有相对应的报文规范。
  - Constrains: 严格遵循IR文档和下列RFC文档的规范，确保代码的准确性和完整性。代码应具有良好的注释和文档，方便后续的维护和扩展。确保statemachine中的每一个状态名，在IR中message的name属性都有相对应的报文规范。
  - OutputFormat: IR文件代码，包含必要的注释和文档说明，描述代码的功能和实现逻辑，同时提供必要的配置参数和运行环境说明。
  - Workflow:
    1. 深入研究IR文档和下列MODBUS over Serial Line Specification V1.02协议文档，理解下列协议的详细规范。
    2. 根据协议规范，设计IR文件的结构，包括协议头、消息类型、消息体等部分。
    3. 编写IR文件代码，确保代码符合协议规范，并添加必要的注释和文档说明。
    4. 严格IR文件提供的代码格式进行编写，不要添加其他元素。
    5. 确保statemachine中的每一个状态名，在IR中message的name属性都有相对应的报文规范。
...
document
  .getElementById("description-prompt-btn")
  .addEventListener("click", function () {
    const desPrompt = `
  - Role: 通信协议架构师和网络安全协议专家
  - Background: 用户需要根据IR文档和下列的RFC协议文档内容，详细定义协议的IR文件结构，并提供完整的IR文件代码。这用户可能正在从事通信协议逆向工程相关的工作，需要对协议进行深入理解和实现。
  - Profile: 你是一位在通信协议领域有着深厚造诣的专家，精通网络安全和模糊测试技术，对下列协议的细节和实现有着全面的掌握。你熟悉IR文档和RFC协议文档的规范，能够精准地将协议的定义转化为代码结构。
  - Skills: 你具备网络协议分析、代码实现、文档解读和结构化编程的能力，能够将复杂的协议规范转化为清晰的代码结构。
  - Goals: 
    1. 根据IR文档和下列RFC协议文档内容，详细定义相应协议的IR文件结构。
    2. 提供完整的IR文件代码，确保代码符合协议规范并具有良好的可读性和可维护性。
    3. 确保statemachine中的每一个状态名，在IR中message的name属性都有相对应的报文规范。
  - Constrains: 严格遵循IR文档和下列RFC文档的规范，确保代码的准确性和完整性。代码应具有良好的注释和文档，方便后续的维护和扩展。确保statemachine中的每一个状态名，在IR中message的name属性都有相对应的报文规范。
  - OutputFormat: IR文件代码，包含必要的注释和文档说明，描述代码的功能和实现逻辑，同时提供必要的配置参数和运行环境说明。
  - Workflow:
    1. 深入研究IR文档和下列RFC协议文档，理解下列协议的详细规范。
    2. 根据协议规范，设计IR文件的结构，包括协议头、消息类型、消息体等部分。
    3. 编写IR文件代码，确保代码符合协议规范，并添加必要的注释和文档说明。
    4. 严格IR文件提供的代码格式进行编写，不要添加其他元素。
    5. 确保statemachine中的每一个状态名，在IR中message的name属性都有相对应的报文规范。
...
generateBtn.addEventListener("click", async () => {
  try {
    ...
    let prompts = promptInput.value.trim(); // ⬅ 实时获取当前输入框内容
    ...
    if (selectedRfc.name == "mqtt-v3.1.1.txt") {
      let target = "Constrains:";
      let toInsert = `
      - 严格遵循IR文档和下列RFC文档的规范，确保代码的准确性和完整性。代码应具有良好的注释和文档，方便后续的维护和扩展。确保statemachine中的每一个状态名，在IR中message的name属性都有相对应的报文规范。
  - 针对以下场景生成 IR 文件：
    - CONNECT：固定 client_id="test-client-id"（长度 14 字节），connect_flags=0x02（Clean Session），无遗嘱、用户名、密码字段。
    - PUBLISH：固定 QoS=1，topic_name="test/topic"（长度 10 字节），payload 长度为 1 字节。
    - 角色分配：CONNECT、SUBSCRIBE、PUBLISH、PUBREL、PINGREQ、DISCONNECT、UNSUBSCRIBE（客户端）；CONNACK、SUBACK、PUBACK、PUBREC、PUBCOMP、PINGRESP、UNSUBACK（服务器）。
    - remaining_length 使用 value="0x00-0x0FFFFFFF"（最大 268,435,455 字节）。
  - 字段命名规范：
    - CONNECT: client_id_length, client_id, connect_flags, keep_alive
    - CONNACK: session_present, return_code
    - PUBLISH: topic_length, topic_name, packet_id, payload
    - SUBSCRIBE: packet_id, topic_filter_length, topic_filter, qos
    - 所有标识符字段使用 id 后缀（例如 packet_id）。
  - 状态机必须完整，覆盖所有消息的后续状态（除 DISCONNECT 外）。
    `;

      let index = prompts.indexOf(target);
      if (index !== -1) {
        let insertPos = index + target.length;
        let result =
          prompts.slice(0, insertPos) + toInsert + prompts.slice(insertPos);
        prompts = result; // 更新 prompts
      } else {
        console.log("未找到目标子字符串");
      }
    }
    ...
    setTimeout(() => {
      ...
      setTimeout(async () => {
        try {
          const formData = new FormData();
          // 拼接 prompt 和文件内容，用换行符分隔
          // const combinedPrompt = `${prompts}\n${fileContent}`;
          // console.log("拼接后的 prompt:", combinedPrompt); // 可选：用于调试

          // formData.append("prompt", combinedPrompt); // ⬅ 发送拼接后的 prompt
          formData.append("prompt", prompts); // ⬅ 发送提示词
...
function initToolbarEvents() {
  ...
  // 添加转移按钮
  document
    .getElementById("add-transition-btn")
  ...
  .addEventListener("click", async () => {
    try {
      ...
      const commParams = {
        ...
        protocol: document.getElementById("protocol")?.value,
        protocol_type:
          document.getElementById("protocol-type")?.value || "mqtt", // 默认mqtt
      };
...
const packetDetailsContainer = document.getElementById(
    ...
    .then((data) => {
      ...
      const processedPackets = data.packets.map((packet) => {
        return {
          ...
          source:
            packet.source || (packet.ethernet ? packet.ethernet.src : "N/A"),
          destination:
            packet.destination ||
            (packet.ethernet ? packet.ethernet.dst : "N/A"),
...
function generatePacketInfo(packet) {
  ...
  if (packet.protocol && /Modbus/i.test(packet.protocol)) {
    ...
    if (packet.modbus) {
      ...
      const funcDesc =
        funcCodes[packet.modbus.func_code] || packet.modbus.func_code;
      info += ` ${funcDesc}`;
  ...
  if (packet.protocol === "DNS" && packet.dns) {
    ...
    return `DNS ${packet.dns.qr ? "Response" : "Query"} ${
      packet.dns.qname || ""
    } (${qtype})`;
  }
...
function processPacketDetails(packet) {
  ...
  if (packet.src_port || packet.dst_port) {
    details.transport = {
      ...
      协议: packet.protocol.includes("TCP")
        ? "TCP"
        : packet.protocol.includes("UDP")
        ? "UDP"
        : "N/A",
...
function renderPackets(packets) {
  ...
  packets.forEach((packet, index) => {
    ...
    row.innerHTML = `
      ...
      <td class="col-dest" data-label="Destination">${
        packet.destination || "N/A"
      }</td>
      <td class="col-protocol" data-label="Protocol">${
        packet.protocol || "N/A"
      }</td>
      <td class="col-length" data-label="Length">${
...
closeDetailsBtn.addEventListener("click", (e) => {
  ...
  hideDetailsPanel();
  document
    .querySelector(".packet-table tr.selected")
